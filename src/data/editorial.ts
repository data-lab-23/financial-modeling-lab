...
export const editorialRecords = [
  ...
  },
  {
    ...
    title: "運転資本モデルの作り方",
    description: "売掛金・棚卸資産・買掛金を回転日数から予測し、正味運転資本、CCC、キャッシュ・フローへ接続します。",
    publishedDate: "2026-07-26",
    modifiedDate: "2026-07-26",
    revisionSummary: "具体的な数値例、Excel数式、レビュー項目、8シート構成の教材を公開しました。",
    sources: [sources.financialStatements, sources.cashFlows, sources.excelFormulas],
  },
  {
    href: "/working-capital/receivables",
    title: "売掛金の予測と回収日数",
    description: "売上高と回収日数から売掛金を予測し、延滞債権と回収条件をExcelモデルへ反映します。",
    publishedDate: "2026-07-26",
    modifiedDate: "2026-07-26",
    revisionSummary: "回収日数の計算例、延滞債権の切り分け、Excel実装を公開しました。",
    sources: [sources.financialInstruments, sources.financialStatements, sources.excelFormulas],
  },
  {
    href: "/working-capital/inventory",
    title: "棚卸資産の予測と在庫回転日数",
    description: "売上原価と在庫回転日数から棚卸資産を予測し、滞留在庫と評価減を切り分けます。",
    publishedDate: "2026-07-26",
    modifiedDate: "2026-07-26",
    revisionSummary: "在庫回転日数の計算例、滞留在庫の扱い、Excel実装を公開しました。",
    sources: [sources.inventories, sources.financialStatements, sources.excelFormulas],
  },
  {
    ...
    publishedDate: "2026-07-26",
    modifiedDate: "2026-07-26",
    revisionSummary: "支払日数の計算例、仕入高との定義差、Excel実装を公開しました。",
    sources: [sources.financialStatements, sources.cashFlows, sources.excelFormulas],
  },
  {
    href: "/working-capital/cash-conversion-cycle",
    title: "CCCの計算と資金繰りへの影響",
    description: "回収日数・在庫回転日数・支払日数からCCCを計算し、運転資金負担を分析します。",
    publishedDate: "2026-07-26",
    modifiedDate: "2026-07-26",
    revisionSummary: "CCCの計算例、勘定別の改善要因、キャッシュ・フローへの接続を公開しました。",
    sources: [sources.cashFlows, sources.financialStatements, sources.excelFormulas],
  },
